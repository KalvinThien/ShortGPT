...
class ShortGptUI(AbstractBaseUI):
    ...
    def create_interface(self):
        ...
        with gr.Blocks(css="footer {visibility: hidden}", title="Thiện Đẹp Trai") as shortGptUI:
    ...
    def launch(self):
        ...
        shortGptServer = shortGptUI.queue(concurrency_count=5, max_size=20)
        shortGptServer.launch(server_port=31415, height=1000, share=self.colab, server_name="0.0.0.0")
